...
exp_name = "exp_htsat_circor_clinical_outcome" # the saved ckpt prefix name of the model 
workspace = "./workspace-circor" # the folder of your code
dataset_path = "./workspace-circor/circor/" # the dataset path
...
#resume_checkpoint = "./workspace-circor/ckpt/htsat_audioset_pretrain.ckpt"
