...
from drive.MyDrive.tcc_colab.utils import get_loss_func, get_mix_lambda, d_prime
import tensorboard
import torch
import torchaudio
...
from drive.MyDrive.tcc_colab.utils import do_mixup, get_mix_lambda, do_mixup_label
import random
...
class SEDWrapper(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.validation_step_outputs.append([pred.detach(), batch["target"].detach()])
    ...
    def test_step(self, batch, batch_idx):
        ...
        if self.config.fl_local:
            ...
            self.test_step_outputs.append([pred.detach(), batch["target"].detach()])
            return [pred.detach(), batch["target"].detach()]
